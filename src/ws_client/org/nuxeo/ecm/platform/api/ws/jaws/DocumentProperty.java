...
public class DocumentProperty  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DocumentProperty)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DocumentProperty.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.api.platform.ecm.nuxeo.org/jaws", "DocumentProperty"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ws.api.platform.ecm.nuxeo.org/jaws", "value"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
    }
