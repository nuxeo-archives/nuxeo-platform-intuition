...
public class WSIntuitionServiceLocator extends org.apache.axis.client.Service
        implements org.nuxeo.ecm.platform.intuition.ws.jaws.WSIntuitionService {
    ...
    public WSIntuitionServiceLocator(java.lang.String wsdlLoc,
    ...
    public org.nuxeo.ecm.platform.intuition.ws.jaws.WSIntuitionInterface getWSIntuitionInterfacePort()
            throws javax.xml.rpc.ServiceException {
    ...
    public org.nuxeo.ecm.platform.intuition.ws.jaws.WSIntuitionInterface getWSIntuitionInterfacePort(
        ...
        try {
            org.nuxeo.ecm.platform.intuition.ws.jaws.WSIntuitionInterfaceBindingStub _stub = new org.nuxeo.ecm.platform.intuition.ws.jaws.WSIntuitionInterfaceBindingStub(
                    portAddress, this);
    ...
    public void setWSIntuitionInterfacePortEndpointAddress(
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface)
        ...
        try {
            if (org.nuxeo.ecm.platform.intuition.ws.jaws.WSIntuitionInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                org.nuxeo.ecm.platform.intuition.ws.jaws.WSIntuitionInterfaceBindingStub _stub = new org.nuxeo.ecm.platform.intuition.ws.jaws.WSIntuitionInterfaceBindingStub(
                        new java.net.URL(WSIntuitionInterfacePort_address),
                        this);
                _stub.setPortName(getWSIntuitionInterfacePortWSDDServiceName());
                return _stub;
            }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName(
                "http://ws.intuition.platform.ecm.nuxeo.org/jaws",
                "WSIntuitionService");
    }
